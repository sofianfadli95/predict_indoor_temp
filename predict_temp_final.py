...
# ndim menunjukkan jumlah dimensi yang diinginkan
# kernel = ConstantKernel([0.5, 0.5], ndim=2) * Matern32Kernel([0.5, 0.5], ndim=2)
# kernel = 10.0 * Matern32Kernel([0.5, 0.5], ndim=2, axes=[0,1])
kernel = 10.0 * ExpSquaredKernel([0.5, 0.5], ndim=2, axes=[0,1]) # Lumayan nih...
# kernel["k1:log_constant"] = np.log(10.0)
